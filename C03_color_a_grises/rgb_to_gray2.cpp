...
void openfiles ()
{
     ...
     printf(" Enter name of *.ppm OUTPUT image file (example: lenaout.ppgm) ");
     scanf("%s",&outfile);
...
void userdefined ()
{
   ...
   do{
		...
		// Asignando pesos a cada uno de los canales
		// Cuidar que los pesos sumen 1
		Gray = ((0.2*Red) + (0.6*Green) + (0.2*Blue));
